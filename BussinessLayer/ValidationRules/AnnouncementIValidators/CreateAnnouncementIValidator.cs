...
namespace BussinessLayer.ValidationRules.AnnouncementIValidators
{
    public class CreateAnnouncementIValidator : AbstractValidator<CreateAnnouncementDto>
    {
        public CreateAnnouncementIValidator()
        {
